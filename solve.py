...
#
# Brief
# Converts a tiling puzzle problem into an exact cover problem. Does exact
# cover matrix generation and solution validation and outputs the valid
# non-isomorphic solutions.
